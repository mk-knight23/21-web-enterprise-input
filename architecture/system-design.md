# 🏗️ System Design: 21-web-enterprise-input

**Repository #21 | Web Application Architecture**

## 📐 Architecture Overview

This document outlines the system architecture for scaling 21-web-enterprise-input into a production SaaS application.
...
- Redis for caching
- Estimated cost: 21-web-enterprise-input00/month
...
|-----------|-----|--------|------------|
| Compute | 21-web-enterprise-input0 | 0 | web00 |
| Database | 21-web-enterprise-input5 | 21-web-enterprise-input00 | 00 |
| CDN |  | 0 | 2100 |
| Monitoring | ../generate-architecture.sh | 0 | 2100 |
| **Total** | **web0** | **2150** | **21-web-enterprise-input200** |
